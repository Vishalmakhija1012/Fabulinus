...
export default function CollegeForm() {
  ...
  return (
    <main className="min-h-screen flex flex-col items-center justify-start bg-gradient-to-b from-[#fff6f7] to-[#fbeee7] px-0 sm:px-4 py-2 sm:py-8 persona-header-gap pt-0 sm:pt-14">
      ...
      >
        <h1 className="text-2xl md:text-3xl font-bold text-[#ef5a63] mb-4 text-center leading-tight">Tell us about your college journey</h1>
        <label className="font-semibold text-[#23242b] text-base mb-1">Highest Qualification
